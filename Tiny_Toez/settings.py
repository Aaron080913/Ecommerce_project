"""
Django settings for Tiny_Toez project.
...
WSGI_APPLICATION = 'Tiny_Toez.wsgi.application'
...
if 'USE_AWS' in os.environ:
    AWS_STORAGE_BUCKET_NAME = 'arn:aws:s3:::tiny-toes2-c149e7780eea'
